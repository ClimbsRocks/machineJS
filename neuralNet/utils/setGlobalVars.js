...
module.exports = function() {
  ...
  nn.minChildTrainingTime = argv.minTrainingTime || 2 * 60; // but also forcing each child to be trained for at least two minutes. allowing a minimum iterations could be disastrous if we have a large data set that takes dozens of minutes or hours to train a single iteration.
